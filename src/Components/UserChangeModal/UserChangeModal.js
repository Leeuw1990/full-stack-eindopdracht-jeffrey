...
function UserChangeModal({ openModal, setOpenModal, activeObject, setUserData }) {
    ...
    async function userChangeData (updateData) {
        ...
        try{
            await axios.patch(`http://localhost:8080/api/users/user/${activeObject.users.username}/details/update`,
                updateData,
                {
                    headers: {
